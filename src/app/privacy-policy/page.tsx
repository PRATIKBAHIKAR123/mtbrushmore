...
const privacySections = [
  {
    ...
    content: `Mt. Brushmore Dental is committed to protecting your privacy and developing technology that gives you the most powerful and safe online experience. This Statement of Privacy applies to our Practice's Web site and governs data collection and usage. By using this website, you consent to the data practices described in this statement.`,
  },
  {
  ...
  },
  {
    ...
    content: `Please contact us by phone at ${contactDetails.phone} or by mail at ${contactDetails.address}`,
  },
];

const sectionIcons = [
  "/Images/mt-brushmore-main-logo-trsnprnt.png",
  "/Images/mt-brushmore-main-logo-trsnprnt.png",
  "/Images/mt-brushmore-main-logo-trsnprnt.png",
  "/Images/mt-brushmore-main-logo-trsnprnt.png",
  "/Images/mt-brushmore-main-logo-trsnprnt.png",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-6 sm:gap-8">
            {privacySections.map((section, index) => (
                <div key={index} className="bg-card rounded-lg p-4 sm:p-6 md:p-8 shadow-lg border border-border">
