...
export default function DecayedTeethClient() {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                    ...
                    <div className="space-y-8">
                        ...
                        <section>
                            ...
                            <p className=" leading-relaxed text-sm md:text-base">
                                We gently loosen and remove the decayed portion of the tooth and rebuild the area with a safe, strong material that restores the tooth’s shape and comfort. Depending on how much of the tooth is affected, restoration may involve a bonded filling or additional protection like a crown. Kids across
