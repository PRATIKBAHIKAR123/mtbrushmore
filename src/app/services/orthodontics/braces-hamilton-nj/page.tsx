          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className=" leading-relaxed text-sm md:text-base">
                ...
                <Link href="/locations/hamilton-nj-pediatric-dentist" className="text-accent font-semibold hover:underline">kids’ braces near me</Link>{" "}love how braces help create a strong bite and a confident smile that lasts a lifetime.
              </p>
            </section>
